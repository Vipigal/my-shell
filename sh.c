...
/* MARK NAME Vinicius Pinho Galvao */
/* MARK NAME Renato Gabino Diniz */
/* MARK NAME E Etc */
...
int main(void) {
  ...
  while (getcmd(buf, sizeof(buf)) >= 0) {
     ...
     *
     * O if do codigo esta testando se existe um diretorio valido
     * no caminho escrito apos o comando "cd" escrito no shell.
     * Ele joga um erro caso nao exista esse caminho.
     * */
